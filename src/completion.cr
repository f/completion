      ...
      if type complete &>/dev/null; then
        #{completion}() {
          if type #{@program} &>/dev/null; then
            COMPREPLY=( $(compgen -W '$(#{@program} __compgen__ \"${COMP_CWORD}\" \"${COMP_WORDS[COMP_CWORD-1]}\" \"${COMP_LINE}\")' -- \"${COMP_WORDS[COMP_CWORD]}\") )
          else
            COMPREPLY=( $(compgen -W '$($1 __compgen__ \"${COMP_CWORD}\" \"${COMP_WORDS[COMP_CWORD-1]}\" \"${COMP_LINE}\")' -- \"${COMP_WORDS[COMP_CWORD]}\") )
          fi
        }
